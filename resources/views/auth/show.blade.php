                    ...
                    <div class="card-body">
                      <h4 class="card-title">Detail <b>{{$data->username}}</b></h4>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Fullame</label>
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="fullname" value="{{ $data->fullname }}" required readonly>
                                @if ($errors->has('name'))
