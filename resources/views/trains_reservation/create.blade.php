...
<form method="POST" action="{{ route('trains_reservation.store') }}"enctype="multypart/form-data">
       {{ csrf_field() }}
<div class="row">
            		...
            		<div class="col-12">
            		   <div class="card">
            		      <div class="card-body">
                            ...
                            <label for="customer_id" class="col-md-4 control-label">Nama Pelanggan</label>
                            <div class="col-md-6">
                                <div class="input-group">
                        ...
                        <div class="form-group{{ $errors->has('trains_schedule_id') ? ' has-error' : '' }}">
                            <label for="planes_schedule_id"class="col-md-4 control-label">Nama Pesawat</label>
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="planes_name" type="text" class="form-control" readonly="" required>
                                <input id="schedule_id" type="hidden" name="trains_schedule_id" value="{{ old('trains_schedule_id') }}" required >
                                <span class="input-group-btn">
                                ...
                                @if ($errors->has('trains_schedule_id'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('trains_schedule_id') }}</strong>
                                    </span>
                                @endif
                        	</div>
                        </div>
                        <div class="form-group{{ $errors->has('planes_code') ? ' has-error' : '' }}">
                            <label for="planes_code" class="col-md-4 control-label">Kode Kereta</label>
                            <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                                <select id="level" class="form-control" name="trains_class_seat" value="{{ old('level') }}" required>
                            ...
                            <a href="{{route('trains_reservation.index')}}" class="btn btn-light pull-right">Back</a>
            		      </div>
            		   </div>
            		</div>
            	</div>
                        ...
                        <tr>
                          <th>
                            ...
                            <tbody>
                                ...
                                <tr class="pilih_airport" data-schedule_id="<?php echo $data->id; ?>" data-planes_name="<?php echo $data->trains_detail->trains->name; ?>" data-planes_code="<?php echo $data->trains_detail->code;?>" data-planes_from="<?php echo $data->from;?>"data-planes_destination="<?php echo $data->destination;?>">
                                    <td class="py-1">
